...
public class AcessoAmericana {
	...
	public static void tearDownTest() throws IOException {
		...
		FileUtils.copyFile(scrFile, new File("C:\\Picture\\TelaCapturadaAmericana.jpg")); // Cola a captura no local
																							// indicado
		driver.quit();
	}

	// 1- Entre em um grande portal de comércio online (Validação através do
	// getTitle)
	@Test
	public void ateste1() {
	...
	public void dteste4() {
		WebElement produto = driver
				.findElement(By.cssSelector(".product-grid-item:nth-child(6) .Placeholder-kse9g2-2"));
		produto.click();
	}
	...
	@Test
	public void dteste6() {
		driver.get("https://sacola.americanas.com.br/simple-basket/#/basket");
	}
